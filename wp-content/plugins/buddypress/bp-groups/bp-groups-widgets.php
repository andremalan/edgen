...
class BP_Groups_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( false, __( 'Updates', 'buddypress' ), $widget_ops );
	...
	function widget( $args, $instance ) {
		...
		if ( empty( $instance['title'] ) )
			$instance['title'] = __( 'Updates', 'buddypress' );
		...
		<?php if ( bp_has_groups( 'user_id=' . $user_id . '&type=' . $instance['group_default'] . '&max=' . $instance['max_groups'] ) ) : ?>
			<div class="item-options" id="groups-list-options">
				<a href="<?php echo site_url( bp_get_groups_root_slug() ); ?>" id="newest-groups"<?php if ( $instance['group_default'] == 'newest' ) : ?> class="selected"<?php endif; ?>><?php _e("Latest Tweets", 'buddypress') ?></a> |
				<a href="<?php echo site_url( bp_get_groups_root_slug() ); ?>" id="recently-active-groups"<?php if ( $instance['group_default'] == 'active' ) : ?> class="selected"<?php endif; ?>><?php _e("Site", 'buddypress') ?></a> |
				<a href="<?php echo site_url( bp_get_groups_root_slug() ); ?>" id="popular-groups" <?php if ( $instance['group_default'] == 'popular' ) : ?> class="selected"<?php endif; ?>><?php _e("Blog", 'buddypress') ?></a>
			</div>
	...
	function form( $instance ) {
		...
		<p>
			...
			<select name="<?php echo $this->get_field_name( 'group_default' ); ?>">
				<option value="newest" <?php if ( $group_default == 'newest' ) : ?>selected="selected"<?php endif; ?>><?php _e( 'Newest Updates', 'buddypress' ) ?></option>
