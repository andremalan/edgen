...
function wpsc_register_post_types() {
	global $wpsc_page_titles;
        $labels = array(
            'name' => _x( 'Students', 'post type name', 'wpsc' ),
            'singular_name' => _x( 'Student', 'post type singular name', 'wpsc' ),
            'add_new' => _x( 'Add New', 'admin menu: add new product', 'wpsc' ),
            'add_new_item' => __('Add New Product', 'wpsc' ),
            'edit_item' => __('Edit Product', 'wpsc' ),
            'new_item' => __('New Student', 'wpsc' ),
            'view_item' => __('View Student', 'wpsc' ),
            'search_items' => __('Search Students', 'wpsc' ),
            'not_found' =>  __('No Students found', 'wpsc' ),
            'not_found_in_trash' => __( 'No students found in Trash', 'wpsc' ),
            'parent_item_colon' => '',
            'menu_name' => __( 'Students', 'wpsc' )
          );
	// Products
