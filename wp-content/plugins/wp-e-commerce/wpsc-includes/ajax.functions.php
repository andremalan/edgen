...
function wpsc_add_to_cart() {
	...
	if ( $state == true ) {
		...
		if ( $parameters['quantity'] <= 0 ) {
			...
			$cart_messages[] = sprintf( _n( 'Sorry, please try a lower amount, someone else has a donation to this student in their pending transactions.', 'Sorry, please try a lower amount, someone else has a donation to this student in their pending transactions.', $quantity, 'wpsc' ), $quantity );
		} else {
			$cart_messages[] = sprintf( __( 'Sorry, please try a lower amount, someone else has a donation to this student in their pending transactions.', 'wpsc' ), $product->post_title	);
		}
	}
