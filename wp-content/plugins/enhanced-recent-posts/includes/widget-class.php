...
jQuery(document).ready(function(){
	jQuery('#enh_rp-show-select-<?php echo $number; ?>').change(function() {
	...
	jQuery('#enh_rp-show-select-<?php echo $number; ?>').val('<?php echo $show_select; ?>');
});
</script>
...
<?php
	...
	*/
	function render_widget($args, $widget_args=1) {
		...
		echo '<!-- Enhanced Recent Posts ' . $enh_rp_plugin->options[$number]['active_version'] . ' -->';	
