                ...
                <div class="olt-swt-designer-main" id="<?php echo $this->get_field_id('designer-main') ?>">
                    <ul>
                        ...
                        <li class="olt-swt-designer-tabs-controls olt-swt-designer-add-tab">
                            <a><span class="ui-icon ui-icon-plusthick" style="float:left;margin-right:.3em;margin-top: -1px;"></span>Add a new tab</a>
                        </li>
                    </ul>
                    <?php foreach($tabs as $id => $tab): ?>
                    <div id="<?php echo $this->get_field_id('tab-'.$id) ?>">
                        <div class="olt-swt-designer-top">
                            <label for="<?php echo $this->get_field_id('tab-'.$id.'-title'); ?>"><?php _e('Title:'); ?></label>
                            ...
                            <p class="olt-swt-designer-tabs-controls olt-swt-designer-delete-tab">
                                <a href="#"><span class="ui-icon ui-icon-trash" style="float:left;margin-right:.3em;margin-top: -2px;"></span>Delete this tab</a>
                            </p>
                        </div>
