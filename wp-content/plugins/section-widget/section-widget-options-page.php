...
function tabbed_section_widget_add_option_page() {
    add_theme_page('Section Widget Settings', 'Section Widget', 10, 'section-widget', 'tabbed_section_widget_option_page');
}
...
<div class="wrap">
    <h2>Section Widget Settings</h2>
    <?php if($updated): ?>
    <div class="updated"><p><strong>Settings updated.</strong></p></div>
    <?php endif; ?>
    <form method="post">
        <h3>Tabbed Section Widget</h3>
        <p>
            Section Widget ships with 25 default <a href="http://jqueryui.com/" target="_blank">jQuery UI</a> themes. You can specify a CSS selector which will be prepended to all CSS rules provided by the theme. Click on the help link below if you are not sure what to do.
        </p>
        <p>
            You may also roll your own theme by selecteing <strong>Bring My Own Stylesheet</strong> in theme menu. If you choose to do this, no extra stylesheet will be loaded and the CSS Scope option will be <strong>ignored</strong>. In this case the <strong>Base</strong> theme will be used in the widget designer. Refer to the <a href="http://jqueryui.com/docs/Theming" target="_blank">theming guide</a> for more information.
        </p>
        <table class="form-table">
            <tr valign="top">
                <th scope="row">
                    <label for="swt-theme">Theme</label>
                </th>
                <td>
                    <select name="swt_theme" id="swt-theme">
                        <option value="none" <?php if($theme == 'none') echo 'selected="selected"'; ?>>
                            Bring My Own Stylesheet
                        </option>
                    ...
                    <span class="description">(<a id="swt-theme-preview-link" href="#">Preview</a>)</span>
                    <div id="swt-theme-preview" style="display:none">
                        ...
                        <p>
                            <a id="swt-theme-preview-hide-link" href="#">Hide preview</a>
                        </p>
                    </div>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">
                    <label for="swt-scope">CSS Scope</label>
                </th>
                <td>
                    <input name="swt_scope" type="text" id="swt-scope" value="<?php echo $scope ?>" class="regular-text code" />
                    <span class="description">Enter a CSS selector to limit the theme's scope (<a id="swt-scope-help-link" href="#">Help is here</a>)</span>
                    <div id="swt-scope-help" style="display:none">
                        <p>
                            This is to ensure the theme you have chosen here will not affect other areas of your site. Generally speaking, you would want to narrow down the scope as much as possible. This would help to override rules defined by your WordPress theme too.
                        </p>
                        <p>
                            If you have no idea what this is all about, we can detect the optimal settings for you. To do this, you would need to have <strong>at least two Tabbed Section Widget</strong> added to your sidebar. You can do that in the <a href="<?php echo admin_url('widgets.php'); ?>">Widgets</a> control panel. You may choose to leave out the content fields so that they would be invisible to your visitors.
                        </p>
                        <p>
                            Once you've done that, come back to this page and click the button below.
                        </p>
                        <div>
                        ...
                        <p>
                            <a id="swt-scope-help-hide-link" href="#">Hide this help message</a>
                        </p>
                    </div>
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    <label for="swt_heightfix">
                        ...
                        Turn this on if the widget looks stretched out on your theme
                    </label>
                </td>
            </tr>
        </table>
