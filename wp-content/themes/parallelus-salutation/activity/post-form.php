<form action="<?php bp_activity_post_form_action() ?>" method="post" id="whats-new-form" name="whats-new-form">
	...
	<div id="whats-new-avatar">
		<a href="<?php echo bp_loggedin_user_domain() ?>">
			...
			echo '<div class="avatar" style="background-image: url(\''.$avatarURL.'\'); "></div>';  // bp_loggedin_user_avatar( 'width=60&height=60' ); ?>
		</a>
	</div>
		...
		<div class="status-container">
			<div class="the-status-content">
				...
				<div id="whats-new-textarea">
					<textarea name="whats-new" id="whats-new" class="textInput commentTextarea" value="" /><?php if ( isset( $_GET['r'] ) ) : ?>@<?php echo esc_attr( $_GET['r'] ) ?> <?php endif; ?></textarea>
				</div>
