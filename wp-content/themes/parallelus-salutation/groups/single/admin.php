...
<?php if ( bp_is_group_admin_screen( 'membership-requests' ) ) : ?>
	...
	<?php else: ?>
		...
		<div id="message" class="messageBox note icon">
			<span><?php _e( 'There are no pending membership requests.', 'buddypress' ); ?></span>
		</div>
...
<?php if ( bp_is_group_admin_screen( 'delete-group' ) ) : ?>
	...
	<div id="message" class="messageBox alert icon">
		<span><?php _e( 'WARNING: Deleting this group will completely remove ALL content associated with it. There is no way back, please be careful with this option.', 'buddypress' ); ?></span>
	</div>
