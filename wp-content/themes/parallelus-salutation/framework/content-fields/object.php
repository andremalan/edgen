...
class content_fields_object extends framework_object_ambassador_1 {
	...
	function init ($settings) {
		...
		add_filter('content_fields_field_types', 'content_fields_field_types');
		$this->field_types = array();
		$this->field_types = apply_filters('content_fields_field_types', $this->field_types);
	...
	*/
	function admin_init() {
		...
		foreach((array) $boxes as $key => $box) {
			...
			$capability = 'content_fields_box_' . $slug;
