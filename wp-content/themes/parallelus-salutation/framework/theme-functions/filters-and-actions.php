...
if ( ! function_exists( '_theme_data_lookup' ) ) :
	...
	function _theme_data_lookup() {
		...
		$theme_data['contact_form'] = array_merge((array)$contact_saved_data['contact_form'], (array)$contact_db_data['contact_form']);
		$theme_data['contact_form']['contact_fields'] = array_merge((array)$contact_saved_data['contact_fields'], (array)$contact_db_data['contact_fields']);
		...
		$design_data['sidebars'] = array_merge((array)$sidebar_saved_data['sidebars'], (array)$sidebar_db_data['sidebars']);
		// Get tab sidebars (saved and DB)
		$design_data['sidebar-tabs'] = array_merge((array)$sidebar_saved_data['tabs'], (array)$sidebar_db_data['tabs']);
		...
		*/
		...
		$design_data['page_headers'] = array_merge((array)$layout_saved_data['page_headers'], (array)$layout_db_data['page_headers']);
		$design_data['page_footers'] = array_merge((array)$layout_saved_data['page_footers'], (array)$layout_db_data['page_footers']);
		$design_data['layouts'] = array_merge((array)$layout_saved_data['layouts'], (array)$layout_db_data['layouts']);
		$design_data['design_setting']['layout'] = array_merge((array)$layout_saved_data['layout_settings']['layout'], (array)$layout_db_data['layout_settings']['layout']);
...
function new_excerpt_length($length) {
	return 50; //ideahack change for home page - originally 250
}
