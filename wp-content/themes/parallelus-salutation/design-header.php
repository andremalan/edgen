		...
		<div class="inner-2">
			...
			if (!empty($sections)) {
				...
				<div id="TopPanel" class="clearfix">
					...
					// 		global $current_user;
					// 		get_currentuserinfo();
					// 		$the_url = get_bloginfo('home') .'/'. BP_MEMBERS_SLUG .'/'. $current_user -> user_login;
					// 		echo '<li><a href="'. $the_url .'" target="_blank" id="Section-Tab-3000" class="sectionTab">Your Profile</a></li>';			
					// 	} 
