				...
				<?php endif; ?>
					<div class="productcol" style="margin-left:<?php echo $image_width + 20; ?>px;" >
						...
						<?php do_action ( 'wpsc_product_form_fields_begin' ); ?>
								...
								<div id="desctext"><?php echo ih_content(wpsc_the_product_description(), 50 );  ?> </div>
								...
								<?php if(wpsc_product_has_stock()) : ?>
									<div class="wpsc_buy_button_container">
										<div class="wpsc_loading_animation">
											...
											<?php else: ?>
										<input type="submit" value="<?php _e('Purchase', 'wpsc'); ?>" name="Buy" class="wpsc_buy_button" id="product_<?php echo wpsc_the_product_id(); ?>_submit_button"/> <!--// ideahack: changed add to cart to donate -->
											<?php endif; ?>
