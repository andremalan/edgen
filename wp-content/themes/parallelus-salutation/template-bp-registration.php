		...
		<div class="page" id="register-page">
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<div class="register-section" id="basic-details-section">
					...
					<input type="text" name="signup_username" id="signup_username" class="textInput" value="<?php bp_signup_username_value() ?>" />

					<label for="signup_email"><?php _e( 'Email Address', 'buddypress' ) ?> <?php _e( '(required)', 'buddypress' ) ?></label>
					<?php do_action( 'bp_signup_email_errors' ) ?>
					<input type="text" name="signup_email" id="signup_email" class="textInput" value="<?php bp_signup_email_value() ?>" />
					...
					<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
						...
						<div class="editfield">
							...
							<?php if ( 'textbox' == bp_get_the_profile_field_type() ) : ?>
								...
								<input type="text" class="textInput" name="<?php bp_the_profile_field_input_name() ?>" id="<?php bp_the_profile_field_input_name() ?>" value="<?php bp_the_profile_field_edit_value() ?>" />
				...
				<?php if ( bp_get_blog_signup_allowed() ) : ?>
					...
					<div class="register-section" id="blog-details-section">
						...
						<div id="blog-details">
							...
							<?php if ( 'yes' == VHOST ) : ?>
								http:// <input type="text" name="signup_blog_url" id="signup_blog_url" class="textInput" value="<?php bp_signup_blog_url_value() ?>" /> .<?php echo str_replace( 'http://', '', site_url() ) ?>
							<?php else : ?>
								<?php echo site_url() ?>/ <input type="text" name="signup_blog_url" id="signup_blog_url" class="textInput" value="<?php bp_signup_blog_url_value() ?>" />
							<?php endif; ?>

							<label for="signup_blog_title"><?php _e( 'Blog Title', 'buddypress' ) ?> <?php _e( '(required)', 'buddypress' ) ?></label>
							<?php do_action( 'bp_signup_blog_title_errors' ) ?>
							<input type="text" name="signup_blog_title" id="signup_blog_title" class="textInput" value="<?php bp_signup_blog_title_value() ?>" />
			...
			<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
				...
				<?php if ( bp_is_active( 'xprofile' ) && !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
					...
					<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
						...
						<p><?php _e( "Why don't you upload an avatar to help our community get to know you better?", 'buddypress' ) ?></p>
