								...
								<?php if(wpsc_product_has_stock()) : ?>
									<div class="wpsc_buy_button_container">
										<div class="wpsc_loading_animation">
											...
											<?php else: ?>
										<input type="submit" value="<?php _e('Donate', 'wpsc'); ?>" name="Buy" class="wpsc_buy_button" id="product_<?php echo wpsc_the_product_id(); ?>_submit_button"/> <!--// ideahack: changed add to cart to donate -->
											<?php endif; ?>
