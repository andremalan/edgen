	...
	<div id="BP-Content">
		...
		<form action="<?php bp_group_creation_form_action(); ?>" method="post" id="create-group-form" class="standard-form" enctype="multipart/form-data">
			...
			<header class="entry-header clearfix">
				...
				<!-- Title / Page Headline -->
				<h1 class="entry-title titleHasButtons"><?php _e( 'Create a Group', 'buddypress' ) ?></h1>
				<div class="titleButtons">
					 &nbsp; <span class="sep">|</span> &nbsp;
					<a class="button boxLink" href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_groups_root_slug() ); ?>"><?php _e( 'Groups Directory', 'buddypress' ) ?></a>
				</div>
									
			</header>

			<div class="item-list-tabs bp-content-tabs no-ajax" id="group-create-tabs" role="navigation">
				<ul>
