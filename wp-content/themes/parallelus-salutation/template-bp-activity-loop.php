...
#
#	This file was created to allow the activity loop to 
#	be referenced directly with full BP styling and 
#	but without the "What's new..." header and tabs.
#


// Only do this if BP is installed and active
	...
	?>
		<div id="BP-Container">
			<div id="BP-Content">
				...
				<?php /*?><div class="item-list-tabs activity-type-tabs bp-content-tabs">
					<ul>
...
<?php endif; //if (bp_plugin_is_active()) { ?>